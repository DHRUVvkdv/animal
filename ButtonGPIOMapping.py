...
colorList = ["red", "blue", "green", "orange", "purple"]  # list of possible color cues that can be given
...
try:
    ...
    screen.fill(defaultScreen)   # fill screen with default color
    pygame.display.flip()       # function call to update screen display
    sound = pygame.mixer.Sound("/home/animalvideogame/BellSoundCue.wav")  # load audio cue
